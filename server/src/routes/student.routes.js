...
router.get('/', authorize('ADMIN', 'SUB_ADMIN', 'ACCOUNTANT', 'TEACHER'), studentController.getStudents);
...
router.get('/:id', authorize('ADMIN', 'SUB_ADMIN', 'ACCOUNTANT', 'TEACHER'), studentController.getStudent);
